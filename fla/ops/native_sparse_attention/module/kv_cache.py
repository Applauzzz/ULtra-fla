...
class NSACache:
    ...
    def _prepare_compress_prefill(
        ...
        )# use cu_seqlens to get compact compressed seqlens
        assert total_len == cu_seqlens[-1].item() # verify the cu_seqlens
        # fill tmp cache
        ...
        _fill_kv_cache(
            ...
            seq_start,
            seq_end,
        ) # keep the left uncompressed kv there
    ...
    def _prepare_compress_decode(
        ...
        # get the uncompressed one out for compressing
