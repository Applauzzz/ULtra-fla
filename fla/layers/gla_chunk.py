...
class GatedLinearAttention(nn.Module):
    ...
    def forward(
        ...
        manual_gk: Optional[torch.Tensor] = None,
        **kwargs: Unpack[Dict]
        ...
        # print(S0.shape if S0 is not None else "S0 is None")
        ...
        return o, None, past_key_values, recurrent_state
