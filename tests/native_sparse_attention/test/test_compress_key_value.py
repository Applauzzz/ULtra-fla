...
import torch
import triton
from native_sparse_attention.ops import linear_compress, adaptivepool_compress
...
if __name__ == "__main__":
    ...
    w = (
        torch.zeros(num_heads, head_dim + pe_dim)
        .uniform_(-1, 1)
        .cuda()
        .bfloat16()
        .requires_grad_()
    ...
    pe = (
        torch.zeros(num_heads, kernel_size, pe_dim)
        .uniform_(-1, 1)
        .cuda()
        .bfloat16()
        .requires_grad_()
    ...
    y, y_cu_seqlens = adaptivepool_compress(
