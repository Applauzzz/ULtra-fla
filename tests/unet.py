...
from fla.models.U_Net import TransformerConfig
from fla.models.U_Net import TransformerForCausalLM
import pdb
...
if __name__ == "__main__":
    ...
    output = model(input_ids=input_ids, labels=input_ids).logits
